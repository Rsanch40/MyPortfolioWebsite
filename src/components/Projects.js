...
function Projects() {
  ...
  const projects = [
    ...
    { id: 3, title: 'Endangered Species Analysis', language: 'Python, Pandas', description: 'A data analysis project that looks into endangered species and the cause of their endangerment. Includes analysis from Machine Learning techniques such as Neural Networks', image: image3, link: 'https://github.com/Rsanch40/Endangered-Species-Data-Project.git'},
    { id: 4, title: 'Portfolio Website', language: 'React.js, Node.js, HTML, CSS, Firebase', description: 'This Website!', image: image4, link: 'https://github.com/Rsanch40/MyPortfolioWebsite' },
    { id: 5, title: '[IN PROGRESS] Queue The Song - A Spotify App', language: 'React.js, Node.js, Tailwind CSS, AWS, Spotify Web API', description: 'A Web App using Spotify API to display currently-playing song, user queue, and allow users to automatically queue songs when conditions are met', link: 'https://github.com/Rsanch40/Queue-The-Song'},
  ];
